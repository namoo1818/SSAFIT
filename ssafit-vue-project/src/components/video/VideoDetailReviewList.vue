<template>
    <div class="d-flex flex-column align-items-stretch flex-shrink-0" style="width: 380px;">
        <a href="#" class="d-flex align-items-center flex-shrink-0 p-3 link-body-emphasis text-decoration-none border-bottom">
          <span class="fs-5 fw-semibold">생생 유저 리뷰🏃‍♂️</span>
        </a>
        <div class="list-group list-group-flush border-bottom scrollarea">
          <div class="list-group-item list-group-item-action py-3 lh-sm"
            ...
            <div class="d-flex w-100 align-items-center justify-content-between">
              ...
              <button class="btn"><small class="text-body-secondary">
                <RouterLink :to="`/others/${review.writer}`">{{ review.userNickname }}</RouterLink></small></button>
            </div>
